const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIwYTNjZmVlMy05MmVmLTRmMTEtYTExOC03NjQ1ODU4OTYzZWQiLCJpZCI6MjI4ODkyLCJpYXQiOjE3MjM5ODEzNTF9.JsD2DD_4BqFngp6aC01aElfMgoXTsfNuea39Pt7b-3U";
...
const transportationContainer = document.getElementsByClassName('transportation-container')[0];
const transportationBtn = document.getElementsByClassName('transportation-btn')[0];
...
const railwayStationsBtn = document.getElementsByClassName('railway-stations-btn')[0];
...
const buswayStationsBtn = document.getElementsByClassName('busway-stations-btn')[0];
...
const heatmapBtnsContainer = document.getElementsByClassName("heatmap-container")[0];
...
const materialFilter = document.getElementsByClassName("filter-Building-Material")[0];
const locationFilter = document.getElementsByClassName("filter-Selected-Location")[0];
const residentialFilter = document.getElementsByClassName("filter-Residential-Buildings")[0];
